...
private String textoCombotipo;
    ...
    public Interfaz_articulo() {
        ...
        textoCombotipo = JOptionPane.showInputDialog(null, "Ingrese el texto para combotipo:");

        Combotipo.setText(textoCombotipo);
...
public void limpiar()
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        if(!des.equals(""))
         {          
        if(ctrl.ingresar_articulo(null,des,preve,precos,sto,tipo,fecha))
         {            
